...
function PP() {
  return (
    <Link href="/private-policy" className="text-green-500">
      Private Policy
    </Link>
  );
}
      ...
      <div className="flex-col md:flex-row items-start lg:m-[80px] xl:m-[108px]">
        ...
        <section className="mt-4 md:mt-6" aria-label="terms-of-service">
          ...
          <p className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
            ...
            (doing business as{" "}
            <span className="font-semibold">Firefly Spark</span>) (
        ...
        <section className="mt-20" aria-label="terms-of-service-definitions">
          ...
          <ul className="list-disc ml-6">
            ...
            <li className="text-base md:text-lg text-gray-200 leading-relaxed py-2">
              ...
              a Spark{" "}
              <span className="font-semibold">posted by Firefly Spark</span>,
              including via accounts we operate,{" "}
              <span className="font-semibold">
                with or without Firefly Spark attribution/branding
              </span>
              , to stimulate supply or showcase ideas; it is a{" "}
              <span className="font-semibold">curated listing only</span> and{" "}
            ...
            <li className="text-base md:text-lg text-gray-200 leading-relaxed py-2">
              ...
              a plan{" "}
              <span className="font-semibold">explicitly labeled in-app</span>{" "}
              as “Official Firefly Spark Event,” presented with separate{" "}
              <span className="font-semibold">
                Official Event Terms & Waiver
              </span>{" "}
              at join. Unless a Spark is labeled this way, it is not an Official
              Firefly Spark Event.
            </li>
          </ul>
          <p className="text-base md:text-lg text-gray-200 leading-relaxed py-2 mt-10">
            ...
            <span className="font-semibold">
              if it is not labeled “Official Firefly Spark Event,” it is a
              User-Started or Platform-Seeded Spark and is not organized or
              hosted by Firefly Spark.
            </span>
          </p>
        ...
        >
          ...
          <p className="text-base md:text-lg text-gray-200 leading-relaxed py-2 mt-10">
            ...
            <span className="font-semibold">do not</span> plan, organize, host,
            supervise, or control Sparks (User-Started or Platform-Seeded),
            venues, or transportation; we{" "}
            <span className="font-semibold">do not</span> guarantee that Sparks
            will occur, fill, or meet expectations; and we do not provide
            background checks, security, or insurance.{" "}
            <span className="font-semibold">
          ...
          <p className="text-base md:text-lg text-gray-200 leading-relaxed py-2 mt-10">
            ...
            in-app and require acceptance of{" "}
            <span className="font-semibold">Official Event Terms & Waiver</span>{" "}
            at join. If you do not see that label and waiver, the Spark is{" "}
        ...
        <section className="mt-20" aria-label="terms-of-service-privacy">
          ...
          <ul className="list-disc ml-6">
            <li className="text-base md:text-lg text-gray-200 leading-relaxed py-2">
              ...
              <span className="font-semibold">Biometric Vision</span> to reduce
              fake accounts and fraud. You consent to our and our vendor&apos;s
            ...
            <li className="text-base md:text-lg text-gray-200 leading-relaxed py-2">
              ...
              <span className="font-semibold">only</span> to members of your
              Spark beginning about{" "}
            ...
            <li className="text-base md:text-lg text-gray-200 leading-relaxed py-2">
              ...
              <span className="font-semibold">
                auto-confirm arrival at/near the venue around start time
              </span>
              . We do <span className="font-semibold">not</span> show exact live
        ...
        <section className="mt-20" aria-label="terms-of-service-sparks">
          ...
          <ul className="list-disc ml-6">
            <li className="text-base md:text-lg text-gray-   py-2 leading-relaxed">
              ...
              <span className="font-semibold">not</span> in the roster until the
              minimum is met (<span className="font-semibold">Auto-join</span>).
              You may
            ...
            <li className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
              ...
              &nbsp; If a Spark drops below your original minimum but still has{" "}
              <span className="font-semibold">≥3 people</span> , we may prompt
              you to <span className="font-semibold">Stay</span> in at the new
              size or <span className="font-semibold">Leave free</span>. If you
            ...
            <li className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
              ...
              stated time; otherwise the Spark cancels and deposits are
              refunded.
            </li>
          </ul>
        ...
        <section className="mt-20" aria-label="terms-of-service-lumins">
          ...
          <ul className="list-disc ml-6">
            <li className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
              ...
              reliability. They: (i) are{" "}
              <span className="font-semibold">not</span> legal tender; (ii) have{" "}
              <span className="font-semibold">no cash value</span>; (iii) are{" "}
              <span className="font-semibold">not</span> redeemable or
              refundable for cash; (iv) are{" "}
              <span className="font-semibold">licensed</span> to you, not sold;
              and (v) may be{" "}
              <span className="font-semibold">
                modified, limited, or discontinued
              </span>{" "}
              prospectively.
            </li>
            <li className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
            ...
            <li className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
              ...
              listings), each participant is responsible for their{" "}
              <span className="font-semibold">own tickets/fees</span> with any
              venue/provider. Lumins are{" "}
              <span className="font-semibold">not</span> tickets and do{" "}
              <span className="font-semibold">not</span> purchase goods or
              services from Firefly Spark
            </li>
          </ul>
        ...
        <section className="mt-20" aria-label="terms-of-service-attendance">
          ...
          <ul className="list-disc ml-6">
            ...
            <li className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
              ...
              &nbsp;
              <span className="font-semibold">−10 Lumins</span> (treated as
              no-show).
            </li>
          </ul>
        ...
        <section className="mt-20" aria-label="terms-of-service-license">
          ...
          <ul className="list-disc ml-6">
            ...
            <li className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
              ...
              and use your content to operate, secure, and improve the service
        ...
        <section className="mt-20" aria-label="terms-of-service-host">
          ...
          <p className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
            ...
            we are not an organizer or host, and we owe{" "}
            <span className="font-semibold">no duty to supervise</span>{" "}
            participants, venues, or third parties. Nothing in these Terms
            creates an agency, partnership, joint venture, employment,
            fiduciary, or special relationship between you and Firefly Spark.{" "}
            <span className="font-semibold">
              The fact that a Spark was posted by an account we operate—whether
              or not it displays Firefly Spark branding—does not make it an
              Official Firefly Spark Event or create a duty to supervise
            </span>
            .
          </p>
        ...
        <section className="mt-20" aria-label="terms-of-service-risks">
          ...
          <ul className="list-disc ml-6">
            <li className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
              ...
              <span className="font-semibold">
                You knowingly and voluntarily assume all risks
              </span>{" "}
            ...
            <li className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
              ...
              , you <span className="font-semibold">release and discharge</span>
              Firefly Spark (Gallop Innovations Inc.) and our officers,
              directors, employees, and agents from{" "}
              <span className="font-semibold">
                claims, demands, losses, damages, or expenses
              </span>{" "}
              (including for <span className="font-semibold">negligence</span>)
              arising out of or related to (a) interactions with users, (b)
              attendance at Sparks (including Platform-Seeded or house-posted
              listings), or (c) third-party services or venues,{" "}
              <span className="font-semibold">except</span>
        ...
        <section className="mt-20" aria-label="terms-of-service-disclaimers">
          ...
          <p className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
            ...
            Firefly Spark is provided{" "}
            <span className="font-semibold">“as is”</span> and{" "}
            <span className="font-semibold">“as available.”</span> We{" "}
            <span className="font-semibold">disclaim all warranties</span>,
            express or implied, including merchantability, fitness for a
            particular purpose, quiet enjoyment, and non-infringement. We do not
            warrant that Sparks will fill, occur, or meet expectations, or that
        ...
        <section className="mt-20" aria-label="terms-of-service-liability">
          ...
          <p className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
            ...
            Firefly Spark and its affiliates will{" "}
            <span className="font-semibold">not be liable</span> for any{" "}
            <span className="font-semibold">
              indirect, incidental, special, consequential, punitive, or
              exemplary damages, or for lost profits, revenue, data, goodwill,
          ...
          <p className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
            ...
            <span className="font-semibold">
              greater of CAD $100 or the amounts you paid us (if any) in the 12
        ...
        <section className="mt-20" aria-label="terms-of-service-indemnity">
          ...
          <p className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
            ...
            Firefly Spark (and our officers, directors, employees, and agents)
            from claims, damages, losses, liabilities, costs, and expenses
            (including reasonable legal fees) arising from or related to: (a)
            your content; (b) your use of the service; (c) your breach of these
        ...
        <section className="mt-20" aria-label="terms-of-service-changes">
          ...
          <p className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
            ...
            service after changes take effect, you agree to the updated Terms.
            We may suspend or terminate accounts to protect users, comply with
            law, or for misuse.
          </p>
        ...
        >
          ...
          <p className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
            ...
            responsible for them. This agreement is between you and Gallop
            Innovations Inc., not Apple or Google. Apple/Google are not
            responsible for the service and have no duty to provide support. You
            must comply with their terms. Apple and Google are third-party
        ...
        <section className="mt-20" aria-label="terms-of-service-disputes">
          ...
          <p className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
            ...
            without regard to conflict rules.
          </p>
        ...
        <section className="mt-20" aria-label="terms-of-service-casl">
          ...
          <p className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
            ...
            or as permitted by <span className="font-semibold">CASL</span>; you
        ...
        >
          ...
          <ul className="list-disc ml-6">
            ...
            <li className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
              ...
              <span className="font-semibold">Stay</span> in or{" "}
            ...
            <li className="text-base md:text-lg text-gray-200 py-2 leading-relaxed">
              ...
              Firefly Spark may also post Sparks from accounts it operates{" "}
              <span className="font-semibold">
                with or without Firefly Spark attribution. Only
              </span>{" "}
              Sparks expressly labeled{" "}
              <span className="font-semibold">
                Official Firefly Spark Event
              </span>{" "}
              are organized by Firefly Spark and require acceptance of{" "}
              <span className="font-semibold">
                Official Event Terms & Waiver
              </span>
              . All other Sparks are curated listings and not organized or
              hosted by Firefly Spark.
            </li>
          </ul>
        </section>
