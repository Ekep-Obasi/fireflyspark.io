    ...
    <main className="pb-4 px-5 md:p-10 max-w-[1450px] mx-auto">
      <div className="flex-col md:flex-row items-start lg:m-[80px] xl:m-[108px]">
        ...
        <section className="mt-12 md:mt-6" aria-label="private-policy">
          ...
          <p className="text-base md:text-lg text-gray-200 my-10 pb-10 border-b border-gray-600">
        ...
        <section className="mt-20" aria-label="private-policy-collect">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-gray-50 mt-10">
            Account & profile
          </h2>
        ...
        <section className="mt-20 mb-40" aria-label="private-policy-contact">
          ...
          <p className="text-base md:text-lg text-gray-200 py-1 mt-10 font-semibold">
            Gallop Innovations Inc. (Firefly Spark)
          </p>
          <p className="text-base md:text-lg text-gray-200 py-1">
            24 Borrows Street, Thornhill, Ontario, L4J 2S4
          </p>
          <p className="text-base md:text-lg text-gray-200 py-1 font-semibold">
            Email: <ContactEmail />
          </p>
        </section>
      </div>
